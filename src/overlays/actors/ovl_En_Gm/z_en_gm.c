...
s32 func_80A3D7C8(void) {
  //if (!GET_EVENTCHKINF(EVENTCHKINF_45) || !GET_EVENTCHKINF(EVENTCHKINF_49)) {
    if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
        return 0;
  //} else if (!CHECK_OWNED_EQUIP_ALT(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BIGGORON) && GET_EVENTCHKINF(EVENTCHKINF_49)) {

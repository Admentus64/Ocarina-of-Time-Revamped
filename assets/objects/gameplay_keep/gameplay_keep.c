...
Gfx gGameplayKeepDL_C8B0[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_CE60, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIA_PRIM, G_CC_MODULATEIA_PRIM),
    gsDPSetRenderMode(G_RM_AA_TEX_EDGE, G_RM_AA_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(gameplay_keepVtx_00C880, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_00C920[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_00C920.vtx.inc"
};
...
Gfx gLockOnArrowDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(gameplay_keepVtx_00C920, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPVertex(&gameplay_keepVtx_00C920[4], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_00C920[35], 12, 0),
...
Vtx gameplay_keepVtx_00CD60[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_00CD60.vtx.inc"
};
...
Gfx gEffFragments2DL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_00CD60, 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSPEndDisplayList(),
};
...
Gfx gBoulderFragmentsDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_00D8B8, 12, 0),
...
Gfx gDoorFrameDL[] = {
    ...
    gsSPVertex(&gameplay_keepVtx_00EC10[68], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
...
Gfx gDoorLeftDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsDPSetPrimColor(0, 0, 170, 170, 170, 255),
    gsSPVertex(gameplay_keepVtx_00EC10, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_OFF),
    gsDPSetCombineMode(G_CC_PRIMITIVE, G_CC_PASS2),
    gsDPSetPrimColor(0, 0, 187, 187, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[4], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(0, 3, 4, 0, 0, 4, 5, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 53, 53, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[10], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 174, 174, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[14], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 93, 93, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[18], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 134, 134, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[26], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
...
Gfx gDoorRightDL[] = {
    ...
    gsDPSetCombineMode(G_CC_MODULATEIA_PRIM, G_CC_PASS2),
    gsDPSetPrimColor(0, 0, 170, 170, 170, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[34], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_OFF),
    gsDPSetCombineMode(G_CC_PRIMITIVE, G_CC_PASS2),
    gsDPSetPrimColor(0, 0, 187, 187, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[38], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(0, 3, 4, 0, 0, 4, 5, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 53, 53, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[44], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 174, 174, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[48], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 93, 93, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[52], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 134, 134, 0, 255),
    gsSPVertex(&gameplay_keepVtx_00EC10[60], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSPDisplayList(gDoorFrameDL),
    gsSPEndDisplayList(),
...
StandardLimb gDoorSkelLimbsLimb_0103D8 = { 
    { 0, 0, 0 }, 0x01, LIMB_DONE,
    NULL
};

StandardLimb gDoorSkelLimbsLimb_0103E4 = { 
    { -2700, 0, 0 }, 0x02, LIMB_DONE,
    NULL
};

StandardLimb gDoorSkelLimbsLimb_0103F0 = { 
    { 0, 0, 0 }, 0x03, LIMB_DONE,
    NULL
};

StandardLimb gDoorSkelLimbsLimb_0103FC = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gDoorLeftDL
};
...
Gfx gEffDustDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_010548, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_010548[] = {
...
Gfx gEffFlash1DL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_010590, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_0126D0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0126D0.vtx.inc"
};
...
Gfx gSpinAttack1DL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_0126D0, 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx gSpinAttack2DL[] = {
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(&gameplay_keepVtx_0126D0[26], 26, 0),
...
Vtx gameplay_keepVtx_012C50[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_012C50.vtx.inc"
};
...
Gfx gSpinAttack3DL[] = {
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_012C50, 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(1, 4, 5, 0, 1, 5, 2, 0),
    gsSP2Triangles(4, 6, 7, 0, 4, 7, 5, 0),
    gsSP2Triangles(6, 8, 9, 0, 6, 9, 7, 0),
...
Gfx gSpinAttack4DL[] = {
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(&gameplay_keepVtx_012C50[26], 26, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 2, 4, 0),
    gsSP2Triangles(3, 0, 2, 0, 5, 4, 6, 0),
    gsSP2Triangles(5, 3, 4, 0, 7, 8, 9, 0),
    gsSP2Triangles(7, 10, 8, 0, 11, 9, 12, 0),
...
Vtx gameplay_keepVtx_0139D0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0139D0.vtx.inc"
};
...
Gfx gSpinAttackChargingDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_0139D0, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx gUnusedBeamBladeDL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_014BA0, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP2Triangles(3, 4, 2, 0, 5, 6, 7, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_014BA0[32], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Vtx gameplay_keepVtx_015860[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_015860.vtx.inc"
};
...
Gfx gFairyWing1DL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_015860, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_015928[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_015928.vtx.inc"
};
...
Gfx gFairyWing2DL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 210, 210, 255, 255),
    gsSPVertex(gameplay_keepVtx_015928, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_0159F0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0159F0.vtx.inc"
};
...
Gfx gFairyWing3DL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 210, 210, 255, 255),
    gsSPVertex(gameplay_keepVtx_0159F0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_015AB8[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_015AB8.vtx.inc"
};
...
Gfx gFairyWing4DL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 210, 210, 255, 255),
    gsSPVertex(gameplay_keepVtx_015AB8, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_015B80[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_015B80.vtx.inc"
};
...
Gfx gGlowCircleDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_015B80, 4, 0),
...
Gfx gGlowCircleSmallDL[] = {
    ...
    gsDPLoadMultiBlock(gCircleGlowSLTex, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                       G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(gameplay_keepVtx_015D88, 4, 0),
    gsSP2Triangles(2, 1, 0, 0, 3, 2, 0, 0),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    ...
    gsDPLoadMultiBlock(gCircleGlowSRTex, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                       G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_015D88[4], 4, 0),
    gsSP2Triangles(2, 1, 0, 0, 3, 2, 0, 0),
...
StandardLimb gFairySkelLimbsLimb_016E14 = { 
    { 0, 0, 0 }, 0x02, 0x04,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E20 = { 
    { 0, 0, 0 }, 0x03, LIMB_DONE,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E2C = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gFairyWing1DL
};

StandardLimb gFairySkelLimbsLimb_016E38 = { 
    { 0, 0, 0 }, 0x05, 0x07,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E44 = { 
    { 0, 0, 0 }, 0x06, LIMB_DONE,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E50 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gFairyWing2DL
};

StandardLimb gFairySkelLimbsLimb_016E5C = { 
    { 0, 0, 0 }, LIMB_DONE, 0x08,
    gGlowCircleSmallDL
};

StandardLimb gFairySkelLimbsLimb_016E68 = { 
    { 0, 0, 0 }, 0x09, 0x0B,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E74 = { 
    { 0, 0, 0 }, 0x0A, LIMB_DONE,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E80 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gFairyWing3DL
};

StandardLimb gFairySkelLimbsLimb_016E8C = { 
    { 0, 0, 0 }, 0x0C, LIMB_DONE,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016E98 = { 
    { 0, 0, 0 }, 0x0D, LIMB_DONE,
    NULL
};

StandardLimb gFairySkelLimbsLimb_016EA4 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gFairyWing4DL
};
...
Vtx gameplay_keepVtx_018870[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_018870.vtx.inc"
};
...
Gfx gEffFireCircleDL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_018870, 14, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Vtx gameplay_keepVtx_018AB0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_018AB0.vtx.inc"
};

Gfx gFishSkelLimbsLimb_01945CDL_018D50[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(gameplay_keepVtx_018AB0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPEndDisplayList(),
};

Gfx gFishSkelLimbsLimb_019450DL_018DF0[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPVertex(&gameplay_keepVtx_018AB0[4], 4, 0),
    ...
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(&gameplay_keepVtx_018AB0[8], 12, 4),
...
Gfx gFishSkelLimbsLimb_019438DL_018F08[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(&gameplay_keepVtx_018AB0[20], 22, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetTextureLUT(G_TT_NONE),
...
StandardLimb gFishSkelLimbsLimb_019420 = { 
    { 0, 0, 0 }, 0x01, LIMB_DONE,
    NULL
};

StandardLimb gFishSkelLimbsLimb_01942C = { 
    { 0, 0, 0 }, 0x02, LIMB_DONE,
    NULL
};

StandardLimb gFishSkelLimbsLimb_019438 = { 
    { 0, 0, 0 }, LIMB_DONE, 0x03,
    gFishSkelLimbsLimb_019438DL_018F08
};

StandardLimb gFishSkelLimbsLimb_019444 = { 
    { 0, 0, 0 }, 0x04, 0x05,
    NULL
};

StandardLimb gFishSkelLimbsLimb_019450 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gFishSkelLimbsLimb_019450DL_018DF0
};

StandardLimb gFishSkelLimbsLimb_01945C = { 
...
Gfx gEffBubbleDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_IA, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_01A678, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_01A678[] = {
...
Gfx gEffFireFootprintDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                         G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_01C720, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_01C720[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_01C720.vtx.inc"
};
...
Gfx gEffUnusedBubblesDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_01E7D0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_01E7D0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_01E7D0.vtx.inc"
};
...
Gfx gEffHitMarkDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_021C68, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_021C68[] = {
...
Gfx gEffMagmaBubbleDL[] = {
    ...
    gsDPLoadTextureBlock_4b(0x08000000, G_IM_FMT_I, 32, 24, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP,
                            G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_024910, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_024910[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_024910.vtx.inc"
};
...
Gfx gEffWaterRippleDL[] = {
    ...
    gsDPLoadTextureBlock(gEffWaterRippleTex, G_IM_FMT_I, G_IM_SIZ_8b, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(gameplay_keepVtx_0259B0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_0259B0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0259B0.vtx.inc"
};
...
Gfx gEffSparkDL[] = {
    ...
    gsDPLoadTextureBlock_4b(0x08000000, G_IM_FMT_I, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP,
                            G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_025A50, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_025A50[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_025A50.vtx.inc"
};
...
Gfx gEffWaterSplashDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_I, G_IM_SIZ_8b, 32, 40, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                         G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_0282F0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_0282F0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0282F0.vtx.inc"
};
...
Gfx gUnknownEffStoneDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_02A390, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_02A390[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_02A390.vtx.inc"
};
...
Gfx gEffLightningDL[] = {
    ...
    gsDPLoadTextureBlock_4b(0x08000000, G_IM_FMT_I, 32, 96, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP,
                            G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_02D438, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_02D438[] = {
...
Gfx gEffEnemyDeathFlameDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_I, G_IM_SIZ_8b, 32, 64, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_0324E8, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_0324E8[] = {
...
Vtx gameplay_keepVtx_033930[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_033930.vtx.inc"
};
...
Gfx gEffIceFragment1DL[] = {
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_033930, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPVertex(&gameplay_keepVtx_033930[3], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
    gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
    gsSP2Triangles(24, 25, 26, 0, 27, 28, 29, 0),
    gsSPVertex(&gameplay_keepVtx_033930[33], 8, 0),
...
Gfx gEffIceFragment3DL[] = {
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_033DB0, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPVertex(&gameplay_keepVtx_033DB0[3], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_033DB0[34], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_033DB0[65], 28, 0),
...
Gfx gBugLimb1DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034770, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034770[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034770.vtx.inc"
};
...
Gfx gBugLimb2DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034860, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034860[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034860.vtx.inc"
};
...
Gfx gBugLimb3DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034950, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034950[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034950.vtx.inc"
};
...
Gfx gBugLimb4DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034A40, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034A40[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034A40.vtx.inc"
};
...
Gfx gBugLimb5DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034B30, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034B30[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034B30.vtx.inc"
};
...
Gfx gBugLimb6DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034C20, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034C20[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034C20.vtx.inc"
};
...
Gfx gBugLimb7DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034D10, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034D10[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034D10.vtx.inc"
};
...
Gfx gBugLimb8DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034E00, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_034E00[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034E00.vtx.inc"
};
...
Gfx gBugLimb9DL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPSetGeometryMode(G_SHADING_SMOOTH),
    gsSPVertex(gameplay_keepVtx_034F00, 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
...
Vtx gameplay_keepVtx_034F00[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_034F00.vtx.inc"
};
...
StandardLimb gBugSkelLimbsLimb_0358C0 = { 
    { 0, 129, 371 }, 0x01, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0358CC = { 
    { 0, 0, 0 }, 0x02, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0358D8 = { 
    { 0, 0, 0 }, LIMB_DONE, 0x03,
    gBugLimb9WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_0358E4 = { 
    { 268, -29, -113 }, 0x04, 0x08,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0358F0 = { 
    { 0, 0, 0 }, 0x05, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0358FC = { 
    { 263, 0, 0 }, 0x06, 0x07,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035908 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb8WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_035914 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb7WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_035920 = { 
    { 346, -29, -61 }, 0x09, 0x0D,
    NULL
};

StandardLimb gBugSkelLimbsLimb_03592C = { 
    { 0, 0, 0 }, 0x0A, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035938 = { 
    { 263, 0, 0 }, 0x0B, 0x0C,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035944 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb6WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_035950 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb5WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_03595C = { 
    { 346, -29, 61 }, 0x0E, 0x12,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035968 = { 
    { 0, 0, 0 }, 0x0F, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035974 = { 
    { 263, 0, 0 }, 0x10, 0x11,
    NULL
};

StandardLimb gBugSkelLimbsLimb_035980 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb2WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_03598C = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb1WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_035998 = { 
    { 268, -29, 113 }, 0x13, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0359A4 = { 
    { 0, 0, 0 }, 0x14, LIMB_DONE,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0359B0 = { 
    { 263, 0, 0 }, 0x15, 0x16,
    NULL
};

StandardLimb gBugSkelLimbsLimb_0359BC = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBugLimb4WrapperWrapperDL
};

StandardLimb gBugSkelLimbsLimb_0359C8 = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
...
Gfx gCuttableShrubStalkDL[] = {
    ...
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_035A40, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_035B10[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_035B10.vtx.inc"
};
...
Gfx gCuttableShrubTipDL[] = {
    ...
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_035B10, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Gfx gLensFlareCircleDL[] = {
    ...
    gsDPLoadTextureBlock_4b(gLensFlareCircleTex, G_IM_FMT_I, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                            G_TX_WRAP, 6, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsSPVertex(gameplay_keepVtx_037CA0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_037CA0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_037CA0.vtx.inc"
};
...
Gfx gEffSparklesDL[] = {
    ...
    gsDPSetCombineLERP(PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0,
                       COMBINED),
    gsDPSetRenderMode(G_RM_PASS, G_RM_ZB_CLD_SURF2),
    gsSPVertex(&gameplay_keepVtx_037CA0[4], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_038200[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_038200.vtx.inc"
};
...
Gfx gHoverBootsCircleDL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_038200, 13, 0),
...
Vtx gameplay_keepVtx_039410[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_039410.vtx.inc"
};
...
Vtx gameplay_keepVtx_039850[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_039850.vtx.inc"
};

Gfx gGameplayKeepDL_39890[] = {
    gsSPMatrix(0x01000000, G_MTX_NOPUSH | G_MTX_MUL | G_MTX_MODELVIEW),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gEffUnknown11Tex, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR
                         | G_TX_WRAP, 5, 5, 1, 15),
    gsDPLoadMultiBlock(gUnknownCircle6Tex, 0x0100, 1, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                       G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    ...
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_039850, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSPEndDisplayList(),
};
...
Gfx gGameplayKeepDL_399B0[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_45A20, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP,
                         G_TX_MIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIDECALA_PRIM, G_CC_PASS2),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_039970, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Gfx gGameplayKeepDL_39A80[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_45220, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP,
                         G_TX_MIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIDECALA_PRIM, G_CC_PASS2),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_039A40, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Gfx gGameplayKeepDL_39B50[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_46220, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP,
                         G_TX_MIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIDECALA_PRIM, G_CC_PASS2),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_039B10, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_039D10[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_039D10.vtx.inc"
};
...
Gfx gLiftableRockDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_039D10, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Gfx gUnusedRockRectangularPrism1DL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_039F40, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Gfx gFlatBlockDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03A2B0, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Gfx gUnusedRockRectangularPrism3DL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03A620, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Vtx gameplay_keepVtx_03A980[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03A980.vtx.inc"
};
...
Gfx gFlatRotBlockDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03A980, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Vtx gameplay_keepVtx_03ACE0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03ACE0.vtx.inc"
};
...
Gfx gSmallCubeDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03ACE0, 24, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
...
Vtx gameplay_keepVtx_03B050[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03B050.vtx.inc"
};
...
Gfx gTreeStumpDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03B050, 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 12, 14, 15, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03B050[20], 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP1Triangle(0, 3, 4, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_03B2F0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03B2F0.vtx.inc"
};
...
Gfx gGrassBladesDL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03B2F0, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(&gameplay_keepVtx_03B2F0[8], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_03B560[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03B560.vtx.inc"
};
...
Gfx gHeartPieceInteriorDL[] = {
    ...
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsDPSetEnvColor(0, 100, 255, 128),
    gsSPVertex(gameplay_keepVtx_03B560, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPVertex(&gameplay_keepVtx_03B560[3], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03B560[34], 10, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03B560[44], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSPEndDisplayList(),
};
...
Gfx gHeartPieceExteriorDL[] = {
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03BA10, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03BA10[32], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsSP2Triangles(8, 9, 10, 0, 10, 11, 8, 0),
    gsSP2Triangles(12, 13, 14, 0, 14, 15, 12, 0),
    ...
    gsSP2Triangles(24, 25, 26, 0, 26, 27, 24, 0),
    gsSP2Triangles(28, 29, 30, 0, 30, 31, 28, 0),
    gsSPVertex(&gameplay_keepVtx_03BA10[64], 16, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsSP2Triangles(8, 9, 10, 0, 10, 11, 8, 0),
    gsSP2Triangles(12, 13, 14, 0, 14, 15, 12, 0),
...
Gfx gHeartContainerInteriorDL[] = {
    ...
    gsSPVertex(&gameplay_keepVtx_03BA10[80], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
    gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03BA10[112], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(3, 5, 6, 0, 7, 8, 9, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_03BA10[144], 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_03C610[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_03C610.vtx.inc"
};

Gfx gGameplayKeepDL_3CFD0[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gHilite2Tex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
    ...
    gsSPSetGeometryMode(G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03C610, 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsSP2Triangles(8, 9, 10, 0, 10, 11, 8, 0),
    gsSP2Triangles(12, 13, 14, 0, 14, 15, 12, 0),
    ...
    gsSP2Triangles(24, 25, 26, 0, 26, 27, 24, 0),
    gsSP2Triangles(28, 29, 30, 0, 30, 31, 28, 0),
    gsSPVertex(&gameplay_keepVtx_03C610[32], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsSP2Triangles(8, 9, 10, 0, 10, 11, 8, 0),
    gsSP2Triangles(12, 13, 14, 0, 14, 15, 12, 0),
    ...
    gsSP2Triangles(24, 25, 26, 0, 26, 27, 24, 0),
    gsSP2Triangles(28, 29, 30, 0, 30, 31, 28, 0),
    gsSPVertex(&gameplay_keepVtx_03C610[64], 16, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    gsSP2Triangles(4, 5, 6, 0, 6, 7, 4, 0),
    gsSP2Triangles(8, 9, 10, 0, 10, 11, 8, 0),
    gsSP2Triangles(12, 13, 14, 0, 14, 15, 12, 0),
...
Gfx gGameplayKeepDL_3D108[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_46A40, G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 4, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 2, 2, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, COMBINED, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    ...
    gsSPVertex(&gameplay_keepVtx_03C610[80], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
    gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
    gsSP2Triangles(24, 25, 26, 0, 27, 28, 29, 0),
    gsSP1Triangle(27, 29, 30, 0),
    gsSPVertex(&gameplay_keepVtx_03C610[111], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    ...
    gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
    gsSP2Triangles(24, 25, 26, 0, 27, 28, 29, 0),
    gsSPVertex(&gameplay_keepVtx_03C610[141], 15, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
...
Gfx gGameplayKeepDL_3D260[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gGameplayKeepTex_46A60, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP,
                         G_TX_MIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetCombineMode(G_CC_MODULATEIDECALA_PRIM, G_CC_PASS2),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03D220, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Gfx gSignRectangularDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03D2F0, 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&gameplay_keepVtx_03D2F0[8], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignRectangularSideTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D2F0[12], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignPostWoodTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 6, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D2F0[16], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignRectangularFrontTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D2F0[20], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignRectangularSideTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D2F0[24], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(3, 5, 6, 0, 7, 8, 9, 0),
    ...
    gsDPLoadTextureBlock(gSignPostWoodTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 6, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D2F0[35], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Gfx gSignDirectionalDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_FOG | G_LIGHTING),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_03D7F0, 5, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP1Triangle(0, 4, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignPostWoodTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 6, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D7F0[5], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignLetteringTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 32, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR
                         | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D7F0[9], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignPostWoodTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 6, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D7F0[13], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignLetteringTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 32, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_MIRROR
                         | G_TX_WRAP, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D7F0[17], 13, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsSP2Triangles(8, 9, 10, 0, 8, 11, 9, 0),
    ...
    gsDPLoadTextureBlock(gSignRectangularSideTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 16, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_MIRROR | G_TX_WRAP, 5, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&gameplay_keepVtx_03D7F0[30], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsDPPipeSync(),
    gsDPSetPrimColor(0, 0, 216, 216, 216, 255),
    gsSPVertex(&gameplay_keepVtx_03D7F0[33], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
    gsDPPipeSync(),
    gsDPLoadTextureBlock(gSignPostWoodTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 8, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 6, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(&gameplay_keepVtx_03D7F0[41], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
u64 gGameplayKeepTex_3FD80[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_3FD80.rgba16.inc.c"
};

u64 gGameplayKeepTex_40580[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_40580.rgba16.inc.c"
};
...
u64 gGameplayKeepTex_41580[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_41580.rgba16.inc.c"
};
...
Gfx gItemDropDL[] = {
    ...
    gsDPLoadTextureBlock(0x08000000, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                         G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_041E08, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_041E08[] = {
...
Vtx gameplay_keepVtx_044F10[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_044F10.vtx.inc"
};
...
Gfx gRupeeDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_044F10, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPVertex(&gameplay_keepVtx_044F10[3], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 10, 11, 0),
    gsSP2Triangles(12, 13, 14, 0, 15, 16, 17, 0),
    gsSP2Triangles(18, 19, 20, 0, 21, 22, 23, 0),
    gsSP2Triangles(24, 25, 26, 0, 27, 28, 29, 0),
    gsSPVertex(&gameplay_keepVtx_044F10[33], 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

u64 gGameplayKeepTex_45220[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_45220.rgba16.inc.c"
};

u64 gGameplayKeepTex_45A20[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_45A20.rgba16.inc.c"
};

u64 gGameplayKeepTex_46220[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_46220.rgba16.inc.c"
};
...
u64 gGameplayKeepTex_46A40[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_46A40.rgba16.inc.c"
};

u64 gGameplayKeepTex_46A60[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_46A60.rgba16.inc.c"
};

u64 gGameplayKeepTex_47260[] = {
#include "assets/objects/gameplay_keep/gameplay_keep_tex_47260.rgba16.inc.c"
};
...
Vtx gameplay_keepVtx_04D660[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_04D660.vtx.inc"
};

Gfx gRaindropDL[] = {
    gsDPSetCombineMode(G_CC_PRIMITIVE, G_CC_PRIMITIVE),
    gsSPVertex(gameplay_keepVtx_04D660, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};
...
Gfx gFootShadowDL[] = {
    ...
    gsDPLoadTextureBlock(gFootShadowTex, G_IM_FMT_IA, G_IM_SIZ_16b, 32, 64, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_04D710, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_04D710[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_04D710.vtx.inc"
};
...
Gfx gCircleShadowDL[] = {
    gsDPLoadTextureBlock(gCircleShadowTex, G_IM_FMT_IA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_04E790, 3, 0),
    gsSP1Triangle(0, 1, 2, 0),
    gsSPEndDisplayList(),
};

Vtx gameplay_keepVtx_04E790[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_04E790.vtx.inc"
};
...
Vtx gameplay_keepVtx_04EFC0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_04EFC0.vtx.inc"
};

Gfx gHorseShadowDL[] = {
    gsDPLoadTextureBlock(gHorseShadowTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 64, 0, G_TX_MIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                         G_TX_CLAMP, 4, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(gameplay_keepVtx_04EFC0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_04F450[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_04F450.vtx.inc"
};
...
Gfx gDungeonDoorDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_04F450, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    gsSPVertex(&gameplay_keepVtx_04F450[4], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPVertex(&gameplay_keepVtx_04F450[8], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
Vtx gameplay_keepVtx_0505C0[] = {
#include "assets/objects/gameplay_keep/gameplay_keepVtx_0505C0.vtx.inc"
};
...
Gfx gDoorMetalBarsDL[] = {
    ...
    gsSPSetGeometryMode(G_CULL_BACK | G_FOG),
    gsDPSetPrimColor(0, 0, 255, 255, 255, 255),
    gsSPVertex(gameplay_keepVtx_0505C0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSPEndDisplayList(),
};
...
u8 gameplay_keep_unaccounted_051E70[] = {
...
u8 gameplay_keep_unaccounted_052670[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};
...
Gfx gKokiriDustMoteModelDL[] = {
    gsSPVertex(&gameplay_keepVtx_052878[12], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSPEndDisplayList(),
};
...
Gfx gSunDL[] = {
    ...
    gsSPVertex(gameplay_keepVtx_052878, 12, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 1, 3, 0),
...
Gfx gEffFire1DL[] = {
    ...
    gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPDisplayList(0x08000000),
    gsSPVertex(gameplay_keepVtx_0529D0, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSPEndDisplayList(),
};
...
Gfx gUnusedUnknownShape1DL[] = {
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[32], 5, 27),
    gsSP1Triangle(9, 21, 29, 0),
    gsSP1Quadrangle(28, 1, 0, 31, 0),
    gsSP1Quadrangle(30, 31, 0, 27, 0),
    gsSPVertex(&gameplay_keepVtx_053B90[37], 11, 21),
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[48], 3, 29),
    gsSP1Quadrangle(21, 30, 29, 0, 0),
    gsSP1Quadrangle(0, 28, 31, 21, 0),
    gsSPVertex(&gameplay_keepVtx_053B90[51], 32, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[83], 28, 4),
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[111], 32, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[143], 29, 3),
    ...
    gsSPVertex(&gameplay_keepVtx_053B90[172], 25, 0),
...
Gfx gUnusedUnknownShape2DL[] = {
    ...
    gsSPVertex(&gameplay_keepVtx_054B70[53], 30, 2),
    ...
    gsSPVertex(&gameplay_keepVtx_054B70[83], 32, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_054B70[115], 29, 3),
    ...
    gsSPVertex(&gameplay_keepVtx_054B70[144], 32, 0),
    ...
    gsSP1Triangle(27, 29, 30, 0),
    gsSPVertex(&gameplay_keepVtx_054B70[176], 26, 4),
...
Gfx gUnusedUnknownShape3DL[] = {
    ...
    gsSPVertex(&gameplay_keepVtx_055B40[77], 28, 4),
    ...
    gsSPVertex(&gameplay_keepVtx_055B40[105], 32, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_055B40[137], 26, 6),
    ...
    gsSPVertex(&gameplay_keepVtx_055B40[163], 32, 0),
    ...
    gsSPVertex(&gameplay_keepVtx_055B40[195], 4, 3),

...
SceneCmd spot18_room_1Set_cleansed[] = {
    SCENE_CMD_ECHO_SETTINGS(10),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&spot18_room_1RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(9, spot18_room_1ObjectList_cleansed),
    SCENE_CMD_ACTOR_LIST(6, spot18_room_1ActorEntry_cleansed),
    SCENE_CMD_END(),
};

s16 spot18_room_1ObjectList_cleansed[] = {
    OBJECT_SPOT18_OBJ,
    OBJECT_BOMBF,
    OBJECT_BOMBIWA,
    OBJECT_OF1D_MAP,
...
ActorEntry spot18_room_1ActorEntry_cleansed[] = {
    { ACTOR_BG_SPOT18_OBJ, {     92,     40,  -1540 }, {      0,      0,      0 }, 0x1100 },
    { ACTOR_OBJ_TSUBO,     {    262,     70,  -1210 }, {      0,      0,      0 }, 0x7108 },
    { ACTOR_OBJ_TSUBO,     {    261,     70,  -1254 }, {      0,      0,      0 }, 0x7303 },
    { ACTOR_OBJ_TSUBO,     {    262,     70,  -1386 }, {      0,      0,      0 }, 0x7502 },
...
u8 spot18_room_1_possiblePadding_cleansed[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

...
SceneCmd spot18_room_2Set_cleansed[] = {
    SCENE_CMD_ECHO_SETTINGS(10),
    SCENE_CMD_ROOM_BEHAVIOR(0x00, 0x04, false, false),
    SCENE_CMD_SKYBOX_DISABLES(false, true),
    SCENE_CMD_TIME_SETTINGS(255, 255, 0),
    SCENE_CMD_ROOM_SHAPE(&spot18_room_2RoomShapeCullable_0000D0),
    SCENE_CMD_OBJECT_LIST(8, spot18_room_2ObjectList_cleansed),
    SCENE_CMD_ACTOR_LIST(6, spot18_room_2ActorEntry_cleansed),
    SCENE_CMD_END(),
};

s16 spot18_room_2ObjectList_cleansed[] = {
    OBJECT_SPOT18_OBJ,
    OBJECT_BOMBF,
    OBJECT_BOMBIWA,
    OBJECT_OF1D_MAP,
...
ActorEntry spot18_room_2ActorEntry_cleansed[] = {
    { ACTOR_EN_GS,        {   -863,    400,   1496 }, {      0, 0X4000,      0 }, 0x3A19 },
    { ACTOR_BG_BREAKWALL, {   -508,    398,   1366 }, {      0, 0X42D8,      0 }, 0x2005 },
    { ACTOR_BG_BREAKWALL, {   -609,    398,   1351 }, {      0, 0X3B06,      0 }, 0xA006 },
    { ACTOR_OBJ_TSUBO,    {   -694,    430,   1196 }, {      0,      0,      0 }, 0x7101 },

...
SceneCmd shop1_sceneCommands[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(shop1_sceneAlternateHeaders),
...
SceneCmd* shop1_sceneAlternateHeaders[] = {
    NULL,
    shop1_sceneSet_1,
    NULL,
};
...
u8 shop1_scene_possiblePadding_1[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
};

SceneCmd shop1_sceneSet_1[] = {
    SCENE_CMD_SOUND_SETTINGS(5, 19, 85),
    SCENE_CMD_ROOM_LIST(1, shop1_sceneRoomList_1),
    SCENE_CMD_MISC_SETTINGS(0x10, 0x0000000E),
    SCENE_CMD_COL_HEADER(&shop1_sceneCollisionHeader_0002B8),
    SCENE_CMD_ENTRANCE_LIST(shop1_sceneEntranceList_1),
    SCENE_CMD_SPECIAL_FILES(NAVI_QUEST_HINTS_NONE, OBJECT_GAMEPLAY_DANGEON_KEEP),
    SCENE_CMD_SPAWN_LIST(2, shop1_sceneStartPositionList_1),
    SCENE_CMD_SKYBOX_SETTINGS(2, 0, true),
    SCENE_CMD_EXIT_LIST(shop1_sceneExitList_1),
    SCENE_CMD_ENV_LIGHT_SETTINGS(1, shop1_sceneLightSettings_1),
    SCENE_CMD_END(),
};

ActorEntry shop1_sceneStartPositionList_1[] = {
    { ACTOR_PLAYER,     {    -30,      0,    144 }, {      0, 0X8000,      0 }, 0x0EFF },
    { ACTOR_PLAYER,     {    -30,      0,    144 }, {      0, 0X8000,      0 }, 0x0EFF },
};

RomFile shop1_sceneRoomList_1[] = {
    { (uintptr_t)_shop1_room_0SegmentRomStart, (uintptr_t)_shop1_room_0SegmentRomEnd },
};

Spawn shop1_sceneEntranceList_1[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
};

u16 shop1_sceneExitList_1[] = {
    ENTR_KAKARIKO_VILLAGE_3,
    ENTR_DEKU_TREE_0,
};

EnvLightSettings shop1_sceneLightSettings_1[] = {
    { 0x46, 0x28, 0x28, 0x1E, 0x5E, 0x4E, 0xB4, 0xAA, 0xAA, 0xD1, 0x6C, 0xD4, 0x3C, 0x3C, 0x28, 0x0A, 0x0A, 0x0A,
    0x07E0, 0x07D0 },
};

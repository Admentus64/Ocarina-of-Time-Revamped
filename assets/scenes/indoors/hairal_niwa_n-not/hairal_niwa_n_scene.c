...
SceneCmd hairal_niwa_n_sceneCommands[] = {
    SCENE_CMD_ALTERNATE_HEADER_LIST(hairal_niwa_n_sceneAlternateHeaders),
...
SceneCmd* hairal_niwa_n_sceneAlternateHeaders[] = {
    NULL,
    hairal_niwa_n_sceneSet_1,
    NULL,
};
...
SurfaceType hairal_niwa_n_sceneCollisionHeader_0010C4SurfaceType[] = {
    {0x00A00002, 0x000057C8},   {0x00000202, 0x000057C8},   {0x00000102, 0x000057C8},   {0x00000002, 0x000057C2},
...
SceneCmd hairal_niwa_n_sceneSet_1[] = {
    SCENE_CMD_SOUND_SETTINGS(9, 3, 127),
    SCENE_CMD_ROOM_LIST(1, hairal_niwa_n_sceneRoomList_1),
    SCENE_CMD_MISC_SETTINGS(0x00, 0x0000000F),
    SCENE_CMD_COL_HEADER(&hairal_niwa_n_sceneCollisionHeader_0010C4),
    SCENE_CMD_ENTRANCE_LIST(hairal_niwa_n_sceneEntranceList_1),
    SCENE_CMD_SPECIAL_FILES(NAVI_QUEST_HINTS_NONE, OBJECT_GAMEPLAY_FIELD_KEEP),
    SCENE_CMD_SPAWN_LIST(2, hairal_niwa_n_sceneStartPositionList_1),
    SCENE_CMD_SKYBOX_SETTINGS(0, 0, false),
    SCENE_CMD_EXIT_LIST(hairal_niwa_n_sceneExitList_1),
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, hairal_niwa_n_sceneLightSettings_1),
    SCENE_CMD_END(),
};

ActorEntry hairal_niwa_n_sceneStartPositionList_1[] = {
    { ACTOR_PLAYER,     {   2254,      0,     83 }, {      0, 0XC000,      0 }, 0x0E00 },
    { ACTOR_PLAYER,     {   1945,      0,    180 }, {      0, 0X4000,      0 }, 0x0F01 },
};

RomFile hairal_niwa_n_sceneRoomList_1[] = {
    { (uintptr_t)_hairal_niwa_n_room_0SegmentRomStart, (uintptr_t)_hairal_niwa_n_room_0SegmentRomEnd },
};

Spawn hairal_niwa_n_sceneEntranceList_1[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
};

u16 hairal_niwa_n_sceneExitList_1[] = {
    ENTR_HYRULE_CASTLE_1,
    ENTR_OUTSIDE_GANONS_CASTLE_0_2,
};

EnvLightSettings hairal_niwa_n_sceneLightSettings_1[] = {
    { 0x46, 0x2D, 0x39, 0x49, 0x49, 0x49, 0xB4, 0x9A, 0x8A, 0xB7, 0xB7, 0xB7, 0x14, 0x14, 0x3C, 0x1E, 0x0A, 0x0A,
    0x07E0, 0x3200 },
    { 0x69, 0x5A, 0x5A, 0x49, 0x49, 0x49, 0xFF, 0xFF, 0xF0, 0xB7, 0xB7, 0xB7, 0x32, 0x32, 0x5A, 0x64, 0x64, 0x78,
    0x07E4, 0x3200 },
